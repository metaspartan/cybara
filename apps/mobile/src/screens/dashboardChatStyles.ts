...
export function createDashboardChatStyles() {
  return {
    ...
    mobileGoalActionDanger: {
      backgroundColor: colors.softRed,
      borderColor: colors.softRedBorder,
    },
    mobileGoalActionPressed: {
      opacity: 0.65,
    },
    mobileGoalActionDisabled: {
      opacity: 0.45,
    },
    mobileGoalActionText: {
      color: colors.textMuted,
      fontSize: typography.tiny,
      fontWeight: "700",
    },
    mobileGoalActionDangerText: {
      color: colors.red,
    },
    mobilePlanHeader: {
      alignItems: "center",
