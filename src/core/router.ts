...
const PROVIDER_PRICING: readonly PricingEntry[] = [
  ...
  ["google", "gemini-3.6-flash", 1.5, 7.5, 0.15],
  ["google", "gemini-3.5-flash-lite", 0.3, 2.5, 0.03],
  ...
  ["xai", "grok-4.5", 2.0, 6.0, 0.3],
  ["xai-oauth", "grok-4.5", 2.0, 6.0, 0.3],
  ...
  ["openrouter", "google/gemini-3.6-flash", 1.5, 7.5, 0.15],
  ["openrouter", "google/gemini-3.5-flash-lite", 0.3, 2.5, 0.03],
  ["openrouter", "moonshotai/kimi-k3", 3.0, 15.0, 0.3],
  ["openrouter", "openai/gpt-5.6-sol", 5.0, 30.0, 0.5, 6.25],
  ["openrouter", "openai/gpt-5.6-sol-pro", 5.0, 30.0, 0.5, 6.25],
  ["openrouter", "openai/gpt-5.6-terra", 2.5, 15.0, 0.25, 3.125],
  ["openrouter", "openai/gpt-5.6-terra-pro", 2.5, 15.0, 0.25, 3.125],
  ["openrouter", "openai/gpt-5.6-luna", 1.0, 6.0, 0.1, 1.25],
  ["openrouter", "openai/gpt-5.6-luna-pro", 1.0, 6.0, 0.1, 1.25],
  ["openrouter", "x-ai/grok-4.5", 2.0, 6.0, 0.3],
  ["openrouter", "meituan/longcat-2.0", 0.3, 1.2, 0.006],
  ["openrouter", "tencent/hy3", 0.132, 0.528, 0.033],
