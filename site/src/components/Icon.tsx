...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  discord: (
    <path
      fill="currentColor"
      stroke="none"
      d="M19.54 5.34A16.3 16.3 0 0 0 15.44 4a11.4 11.4 0 0 0-.52 1.06 15.18 15.18 0 0 0-5.84 0A11.4 11.4 0 0 0 8.56 4a16.3 16.3 0 0 0-4.1 1.34C1.86 9.2 1.15 12.95 1.5 16.65a16.5 16.5 0 0 0 5.03 2.53c.41-.55.77-1.13 1.08-1.74-.59-.22-1.15-.49-1.68-.8.14-.1.28-.21.41-.32 3.24 1.51 6.75 1.51 9.95 0 .14.11.27.22.41.32-.53.31-1.1.58-1.68.8.31.61.67 1.19 1.08 1.74a16.5 16.5 0 0 0 5.03-2.53c.42-4.29-.72-8-3.59-11.31ZM8.5 14.37c-.98 0-1.78-.9-1.78-2s.78-2 1.78-2 1.8.9 1.78 2c0 1.1-.79 2-1.78 2Zm6 0c-.98 0-1.78-.9-1.78-2s.78-2 1.78-2 1.8.9 1.78 2c0 1.1-.79 2-1.78 2Z"
    />
  ),
};
