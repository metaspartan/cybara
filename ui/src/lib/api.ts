...
export const subagentApi = {
  ...
  list: () => fetchApi<{ id: string; label: string; status: string; createdAt: string }[]>('/subagents'),
  get: (id: string) => fetchApi<{ id: string; label: string; status: string; result?: unknown }>(`/subagents/${id}`),
