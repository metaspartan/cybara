            ...
            <div className="flex-1 overflow-auto">
                {isEditing ? (
                    <textarea
                        ...
                        className="w-full h-full p-4 bg-transparent font-mono text-sm text-gray-300 resize-none !outline-none focus:!outline-none"
                        spellCheck={false}
                    />
                ) : (
...
export function IDE() {
    ...
    return (
        <PageLayout
            title="IDE"
            subtitle="Browse, view, and edit files with LSP diagnostics"
            actions={
                <div className="flex items-center gap-2">
                    <Button
                        variant="ghost"
                        ...
                        className={cn(autoRefresh && 'text-emerald-400')}
                    >
                        {autoRefresh ? <Eye className="w-4 h-4" /> : <EyeOff className="w-4 h-4" />}
                        <span className="ml-1">{autoRefresh ? 'Live' : 'Static'}</span>
                    </Button>
                ...
                <CardContent className="p-0 flex h-[calc(100vh-200px)]">
                    ...
                    <div className="w-72 border-r border-white/10 flex flex-col overflow-hidden">
                        ...
                        <div className="px-3 py-2 border-b border-white/10 flex items-center gap-2 bg-white/5">
                            <Button variant="ghost" size="sm" onClick={handleGoHome} className="p-1">
