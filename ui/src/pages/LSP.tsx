...
import { useLSPInstallStatus, useInstallLSP, useUninstallLSP, type LSPInstallStatus } from '@/hooks/useApi';
            ...
            <div className="p-4">
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                        <div className={cn('w-12 h-12 rounded-lg flex items-center justify-center', meta.color)}>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400 mt-1">
                                    Language servers provide diagnostics, go-to-definition, find references, and hover information.
                                    TypeScript/JavaScript are bundled in the binary. Other languages can be installed on-demand.
                                </p>
                            </div>
                        </div>
                    </CardContent>
                        ...
                        <Card className="border-gray-700/50">
                            <CardContent className="p-4">
                                <div className="text-xs text-gray-500">
                                    ...
                                    <span className="ml-2">Installed language servers are stored locally and persist across binary updates.</span>
                                </div>
                            </CardContent>
                        </Card>
                    </>
