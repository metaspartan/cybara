            ...
            <div className="h-screen flex items-center justify-center bg-[#0a0a0f]">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-gray-400 mb-4">
                        The web terminal is disabled by default for security.
                        Start Cybara with the <code className="text-indigo-400">--enable-terminal</code> flag to activate it.
                    </p>
            ...
            <div className="flex items-center gap-1 px-3 py-2 bg-white/[0.02] border-b border-white/10">
                ...
                {sessions.map(s => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium transition-all cursor-pointer ${activeSession === s.id
